...
Liferay.Loader.define('my-project$react-dom@16.8.6/cjs/react-dom-unstable-fire.development', ['module', 'exports', 'require', 'my-project$react', 'my-project$object-assign', 'my-project$prop-types/checkPropTypes', 'my-project$scheduler', 'my-project$scheduler/tracing'], function (module, exports, require) {
  ...
  var global = window;
  {
    (function () {
      ...
      var React = require('my-project$react');
      var _assign = require('my-project$object-assign');
      var checkPropTypes = require('my-project$prop-types/checkPropTypes');
      var scheduler = require('my-project$scheduler');
      var tracing = require('my-project$scheduler/tracing');
