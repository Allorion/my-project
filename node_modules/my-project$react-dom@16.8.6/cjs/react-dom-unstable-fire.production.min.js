...
*/
'use strict';
Liferay.Loader.define("my-project$react-dom@16.8.6/cjs/react-dom-unstable-fire.production.min", ['module', 'exports', 'require', 'my-project$react', 'my-project$object-assign', 'my-project$scheduler'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    var aa = require("my-project$react"),
        n = require("my-project$object-assign"),
        r = require("my-project$scheduler");function ba(a, b, c, d, e, f, g, h) {
      if (!a) {
