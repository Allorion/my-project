...
'use strict';
Liferay.Loader.define("my-project$react-dom@16.8.6/cjs/react-dom-server.node.production.min", ['module', 'exports', 'require', 'my-project$object-assign', 'my-project$react', 'my-project$stream'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    var p = require("my-project$object-assign"),
        q = require("my-project$react"),
        aa = require("my-project$stream");function ba(a, b, d, c, f, e, h, g) {
      if (!a) {
