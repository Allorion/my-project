...
Liferay.Loader.define('my-project$loose-envify@1.4.0/cli', ['module', 'exports', 'require', '.', 'my-project$fs'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    var looseEnvify = require('.');
    var fs = require('my-project$fs');
